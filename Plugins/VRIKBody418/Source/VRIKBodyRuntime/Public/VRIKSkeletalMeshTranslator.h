...
struct FSkeletalMeshSetup
{
	...
	// Upperarm Length scaled
	UPROPERTY(BlueprintReadOnly, Category = "Skeletal Mesh Setup")
		float fCurrLeftUpperarmLength;
	// Lowerarm Length scaled
	UPROPERTY(BlueprintReadOnly, Category = "Skeletal Mesh Setup")
		float fCurrLeftForearmLength;
	// Upperarm Length scaled
	UPROPERTY(BlueprintReadOnly, Category = "Skeletal Mesh Setup")
		float fCurrRightUpperarmLength;
	// Lowerarm Length scaled
	UPROPERTY(BlueprintReadOnly, Category = "Skeletal Mesh Setup")
		float fCurrRightForearmLength;
	...
	UPROPERTY()
	FVector DefaultLeftHandScale;

	UPROPERTY()
	FVector DefaultRightHandScale;
};
