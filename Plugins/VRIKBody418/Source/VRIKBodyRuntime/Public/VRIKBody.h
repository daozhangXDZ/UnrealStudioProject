...
#define VERSION_ENGINE_MINOR 18
...
public:	
	...
	UPROPERTY(EditAnywhere, Category = "IKBody | Body Params")
		float fUpperarm_Left_Length;
	// Lowerarm Length scaled
	UPROPERTY(EditAnywhere, Category = "IKBody | Body Params")
		float fForearm_Left_Length;

	UPROPERTY(EditAnywhere, Category = "IKBody | Body Params")
		float fUpperarm_Right_Length;
	// Lowerarm Length scaled
	UPROPERTY(EditAnywhere, Category = "IKBody | Body Params")
		float fForearm_Right_Length;
	 ...
	 * 模型原始高度
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "IKBody | SkeletalMeshParam")
	FSkeletalMeshBodyData SkeletoneDefaultParams;
	////////////////////////////////////GY 扩展-原始模型的数据 结束//////////////////////////////////////
...
private:
	 ...
	 */
	UFUNCTION()
	void CalibrateSkeletonByBodyHeight();
