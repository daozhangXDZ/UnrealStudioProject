...
#include "DZPhySphereComponent.generated.h"
 ...
 * 
 */
UCLASS(collapsecategories, ClassGroup = DZPhysicsStudio, hidecategories = Object, meta = (BlueprintSpawnableComponent))
class DZPHYSICSSTUDIO_API UDZPhySphereComponent : public USphereComponent
{
