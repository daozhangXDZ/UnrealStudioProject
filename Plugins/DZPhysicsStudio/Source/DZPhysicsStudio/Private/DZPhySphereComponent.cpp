...
#include "DZPhySphereComponent.h"
...
UDZPhySphereComponent::UDZPhySphereComponent(const FObjectInitializer& ObjectInitializer)
...
void UDZPhySphereComponent::OnUnregister()
{
	if (GrabbedComponent)
	{
		ReleaseComponent();
...
void UDZPhySphereComponent::GrabComponent(class UPrimitiveComponent* InComponent, FName InBoneName, FVector GrabLocation, bool bConstrainRotation)
{
...
void UDZPhySphereComponent::GrabComponentAtLocation(class UPrimitiveComponent* Component, FName InBoneName, FVector GrabLocation)
{
	GrabComponentImp(Component, InBoneName, GrabLocation, FRotator::ZeroRotator, false);
}

void UDZPhySphereComponent::GrabComponentAtLocationWithRotation(class UPrimitiveComponent* Component, FName InBoneName, FVector GrabLocation, FRotator Rotation)
{
	GrabComponentImp(Component, InBoneName, GrabLocation, Rotation, true);
}

void UDZPhySphereComponent::GrabComponentImp(UPrimitiveComponent* InComponent, FName InBoneName, const FVector& Location, const FRotator& Rotation, bool bConstrainRotation)
{
...
void UDZPhySphereComponent::UpdateDriveSettings()
{
#if WITH_PHYSX
...
void UDZPhySphereComponent::ReleaseComponent()
{
#if WITH_PHYSX
	if (GrabbedComponent)
	{
...
UPrimitiveComponent* UDZPhySphereComponent::GetGrabbedComponent() const
{
	return GrabbedComponent;
}

void UDZPhySphereComponent::SetTargetLocation(FVector NewLocation)
{
	TargetTransform.SetTranslation(NewLocation);
}

void UDZPhySphereComponent::SetTargetRotation(FRotator NewRotation)
{
	TargetTransform.SetRotation(NewRotation.Quaternion());
}

void UDZPhySphereComponent::SetTargetLocationAndRotation(FVector NewLocation, FRotator NewRotation)
{
	TargetTransform = FTransform(NewRotation, NewLocation);
}


void UDZPhySphereComponent::UpdateHandleTransform(const FTransform& NewTransform)
{
	if (!KinActorData)
	{
		return;
...
void UDZPhySphereComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
...
void UDZPhySphereComponent::GetTargetLocationAndRotation(FVector& OutLocation, FRotator& OutRotation) const
{
	OutRotation = TargetTransform.Rotator();
	OutLocation = TargetTransform.GetTranslation();
}

//void UDZPhySphereComponent::SetLinearDamping(float NewLinearDamping)
//{
//	LinearDamping = NewLinearDamping;
//	UpdateDriveSettings();
//}
//
//void UDZPhySphereComponent::SetLinearStiffness(float NewLinearStiffness)
//{
//	LinearStiffness = NewLinearStiffness;
//	UpdateDriveSettings();
//}
//
//void UDZPhySphereComponent::SetAngularDamping(float NewAngularDamping)
//{
//	AngularDamping = NewAngularDamping;
//	UpdateDriveSettings();
//}
//
//void UDZPhySphereComponent::SetAngularStiffness(float NewAngularStiffness)
//{
//	AngularStiffness = NewAngularStiffness;
//	UpdateDriveSettings();
//}
//
//void UDZPhySphereComponent::SetInterpolationSpeed(float NewInterpolationSpeed)
//{
